...
TestEntry testCaseList[] = {
    ...
    { 0, "Basic", "Write Enums", "writeenum.pas", "" },
...
TestEntry negativeCaseList[] = { { 0, "CompErr", "Goto err", "goto.pas", "" },
                                 ...
                                 { LACSAP_ONLY, "CompErr", "Duplicate member function Definition",
                                   "dupmembfunc.pas", "" },
                                 ...
                                 { 0, "CompErr", "Non-integer index", "non-int-index.pas", "" },
                                 { 0, "CompErr", "Non-integer index v2", "non-int-index2.pas", "" },
